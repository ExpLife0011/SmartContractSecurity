...
contract DSTokenBase is ERC20, DSMath {
    ...
    function balanceOf(address src) public constant returns (uint) {
        return _balances[src];
    }
    function allowance(address src, address guy) public constant returns (uint) {
...
contract DSToken is DSTokenBase(0), DSStop {
    ...
    function trusted(address src, address guy) public constant returns (bool) {
